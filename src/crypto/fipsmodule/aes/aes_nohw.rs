...
#[inline]
unsafe extern "C" fn aes_nohw_shift_left(
    mut a: aes_word_t,
    mut i: aes_word_t,
) -> aes_word_t {
    return a << i * 4 as libc::c_int as aes_word_t;
}
#[inline]
unsafe extern "C" fn aes_nohw_shift_right(
    mut a: aes_word_t,
    mut i: aes_word_t,
) -> aes_word_t {
    return a >> i * 4 as libc::c_int as aes_word_t;
...
unsafe extern "C" fn aes_nohw_batch_set(
    ...
    if i < 4 as libc::c_int as size_t {} else {
        __assert_fail(
            b"i < AES_NOHW_BATCH_SIZE\0" as *const u8 as *const libc::c_char,
            b"/home/ubuntu/workspace/oss/aws-lc/crypto/fipsmodule/aes/aes_nohw.c\0"
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 70],
            >(
                b"void aes_nohw_batch_set(AES_NOHW_BATCH *, const aes_word_t *, size_t)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    (*batch).w[i as usize] = *in_0.offset(0 as libc::c_int as isize);
    (*batch)
        .w[i.wrapping_add(4 as libc::c_int as size_t)
        as usize] = *in_0.offset(1 as libc::c_int as isize);
}
#[inline]
unsafe extern "C" fn aes_nohw_batch_get(
    ...
    if i < 4 as libc::c_int as size_t {} else {
        __assert_fail(
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 70],
            >(
                b"void aes_nohw_batch_get(const AES_NOHW_BATCH *, aes_word_t *, size_t)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    *out.offset(0 as libc::c_int as isize) = (*batch).w[i as usize];
    *out
        .offset(
            1 as libc::c_int as isize,
        ) = (*batch).w[i.wrapping_add(4 as libc::c_int as size_t) as usize];
}
#[inline]
...
#[inline]
unsafe extern "C" fn aes_nohw_compact_word(mut a: uint64_t) -> uint64_t {
    a = aes_nohw_delta_swap(
        a,
        0xf000f000f000f0 as libc::c_ulong,
        4 as libc::c_int as aes_word_t,
    );
    a = aes_nohw_delta_swap(
        a,
        0xff000000ff00 as libc::c_ulong,
        8 as libc::c_int as aes_word_t,
    );
    a = aes_nohw_delta_swap(
        a,
        0xffff0000 as libc::c_ulong,
        16 as libc::c_int as aes_word_t,
    );
    return a;
}
#[inline]
unsafe extern "C" fn aes_nohw_uncompact_word(mut a: uint64_t) -> uint64_t {
    a = aes_nohw_delta_swap(
        a,
        0xffff0000 as libc::c_ulong,
        16 as libc::c_int as aes_word_t,
...
#[inline]
unsafe extern "C" fn aes_nohw_compact_block(
    mut out: *mut aes_word_t,
    ...
    let mut a0: uint64_t = aes_nohw_compact_word(*out.offset(0 as libc::c_int as isize));
    let mut a1: uint64_t = aes_nohw_compact_word(*out.offset(1 as libc::c_int as isize));
    *out
        .offset(
            0 as libc::c_int as isize,
        ) = a0 & 0xffffffff as libc::c_ulong | a1 << 32 as libc::c_int;
    *out
        .offset(
            1 as libc::c_int as isize,
        ) = a1 & 0xffffffff00000000 as libc::c_ulong | a0 >> 32 as libc::c_int;
}
#[inline]
unsafe extern "C" fn aes_nohw_uncompact_block(
    mut out: *mut uint8_t,
    mut in_0: *const aes_word_t,
) {
    let mut a0: uint64_t = *in_0.offset(0 as libc::c_int as isize);
    let mut a1: uint64_t = *in_0.offset(1 as libc::c_int as isize);
    let mut b0: uint64_t = aes_nohw_uncompact_word(
        a0 & 0xffffffff as libc::c_ulong | a1 << 32 as libc::c_int,
    );
    let mut b1: uint64_t = aes_nohw_uncompact_word(
        a1 & 0xffffffff00000000 as libc::c_ulong | a0 >> 32 as libc::c_int,
    );
    CRYPTO_store_u64_le(
        &mut *out.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut libc::c_void,
        b0,
    );
    CRYPTO_store_u64_le(
        &mut *out.offset(8 as libc::c_int as isize) as *mut uint8_t as *mut libc::c_void,
        b1,
    );
}
#[inline]
unsafe extern "C" fn aes_nohw_swap_bits(
    ...
    let mut mask_w: aes_word_t = (mask as uint64_t) << 32 as libc::c_int
        | mask as uint64_t;
...
unsafe extern "C" fn aes_nohw_transpose(mut batch: *mut AES_NOHW_BATCH) {
    aes_nohw_swap_bits(
        &mut *((*batch).w).as_mut_ptr().offset(0 as libc::c_int as isize),
        &mut *((*batch).w).as_mut_ptr().offset(1 as libc::c_int as isize),
        0x55555555 as libc::c_int as uint32_t,
        1 as libc::c_int as aes_word_t,
    );
    aes_nohw_swap_bits(
        &mut *((*batch).w).as_mut_ptr().offset(2 as libc::c_int as isize),
        &mut *((*batch).w).as_mut_ptr().offset(3 as libc::c_int as isize),
        0x55555555 as libc::c_int as uint32_t,
        1 as libc::c_int as aes_word_t,
    );
    aes_nohw_swap_bits(
        &mut *((*batch).w).as_mut_ptr().offset(4 as libc::c_int as isize),
        &mut *((*batch).w).as_mut_ptr().offset(5 as libc::c_int as isize),
        0x55555555 as libc::c_int as uint32_t,
        1 as libc::c_int as aes_word_t,
    );
    aes_nohw_swap_bits(
        &mut *((*batch).w).as_mut_ptr().offset(6 as libc::c_int as isize),
        &mut *((*batch).w).as_mut_ptr().offset(7 as libc::c_int as isize),
        0x55555555 as libc::c_int as uint32_t,
        1 as libc::c_int as aes_word_t,
    );
    aes_nohw_swap_bits(
...
unsafe extern "C" fn aes_nohw_to_batch(
    ...
    memset(
        out as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<AES_NOHW_BATCH>() as libc::c_ulong,
    );
    if num_blocks <= 4 as libc::c_int as size_t {} else {
        __assert_fail(
            b"num_blocks <= AES_NOHW_BATCH_SIZE\0" as *const u8 as *const libc::c_char,
            b"/home/ubuntu/workspace/oss/aws-lc/crypto/fipsmodule/aes/aes_nohw.c\0"
                as *const u8 as *const libc::c_char,
    ...
    'c_11709: {
        if num_blocks <= 4 as libc::c_int as size_t {} else {
            __assert_fail(
                b"num_blocks <= AES_NOHW_BATCH_SIZE\0" as *const u8
    ...
    while i < num_blocks {
        let mut block: [aes_word_t; 2] = [0; 2];
        aes_nohw_compact_block(
            block.as_mut_ptr(),
            in_0.offset((16 as libc::c_int as size_t * i) as isize),
        );
...
unsafe extern "C" fn aes_nohw_from_batch(
    ...
    while i < num_blocks {
        ...
        aes_nohw_uncompact_block(
            out.offset((16 as libc::c_int as size_t * i) as isize),
...
unsafe extern "C" fn aes_nohw_add_round_key(
    ...
    while i < 8 as libc::c_int as size_t {
        (*batch)
            .w[i as usize] = aes_nohw_xor((*batch).w[i as usize], (*key).w[i as usize]);
        i = i.wrapping_add(1);
        i;
    }
}
unsafe extern "C" fn aes_nohw_sub_bytes(mut batch: *mut AES_NOHW_BATCH) {
    let mut x0: aes_word_t = (*batch).w[7 as libc::c_int as usize];
    let mut x1: aes_word_t = (*batch).w[6 as libc::c_int as usize];
    let mut x2: aes_word_t = (*batch).w[5 as libc::c_int as usize];
    let mut x3: aes_word_t = (*batch).w[4 as libc::c_int as usize];
    let mut x4: aes_word_t = (*batch).w[3 as libc::c_int as usize];
    let mut x5: aes_word_t = (*batch).w[2 as libc::c_int as usize];
    let mut x6: aes_word_t = (*batch).w[1 as libc::c_int as usize];
    let mut x7: aes_word_t = (*batch).w[0 as libc::c_int as usize];
    ...
    (*batch).w[0 as libc::c_int as usize] = s7;
    (*batch).w[1 as libc::c_int as usize] = s6;
    (*batch).w[2 as libc::c_int as usize] = s5;
    (*batch).w[3 as libc::c_int as usize] = s4;
    (*batch).w[4 as libc::c_int as usize] = s3;
    (*batch).w[5 as libc::c_int as usize] = s2;
    (*batch).w[6 as libc::c_int as usize] = s1;
    (*batch).w[7 as libc::c_int as usize] = s0;
}
unsafe extern "C" fn aes_nohw_sub_bytes_inv_affine(mut batch: *mut AES_NOHW_BATCH) {
    let mut a0: aes_word_t = (*batch).w[0 as libc::c_int as usize];
    let mut a1: aes_word_t = (*batch).w[1 as libc::c_int as usize];
    let mut a2: aes_word_t = (*batch).w[2 as libc::c_int as usize];
    let mut a3: aes_word_t = (*batch).w[3 as libc::c_int as usize];
    let mut a4: aes_word_t = (*batch).w[4 as libc::c_int as usize];
    let mut a5: aes_word_t = (*batch).w[5 as libc::c_int as usize];
    let mut a6: aes_word_t = (*batch).w[6 as libc::c_int as usize];
    let mut a7: aes_word_t = (*batch).w[7 as libc::c_int as usize];
    let mut b0: aes_word_t = aes_nohw_xor(a2, aes_nohw_xor(a5, a7));
    let mut b1: aes_word_t = aes_nohw_xor(a3, aes_nohw_xor(a6, a0));
    let mut b2: aes_word_t = aes_nohw_xor(a4, aes_nohw_xor(a7, a1));
    let mut b3: aes_word_t = aes_nohw_xor(a5, aes_nohw_xor(a0, a2));
    let mut b4: aes_word_t = aes_nohw_xor(a6, aes_nohw_xor(a1, a3));
    let mut b5: aes_word_t = aes_nohw_xor(a7, aes_nohw_xor(a2, a4));
    let mut b6: aes_word_t = aes_nohw_xor(a0, aes_nohw_xor(a3, a5));
    let mut b7: aes_word_t = aes_nohw_xor(a1, aes_nohw_xor(a4, a6));
    (*batch).w[0 as libc::c_int as usize] = aes_nohw_not(b0);
    (*batch).w[1 as libc::c_int as usize] = b1;
    (*batch).w[2 as libc::c_int as usize] = aes_nohw_not(b2);
    (*batch).w[3 as libc::c_int as usize] = b3;
    (*batch).w[4 as libc::c_int as usize] = b4;
    (*batch).w[5 as libc::c_int as usize] = b5;
    (*batch).w[6 as libc::c_int as usize] = b6;
    (*batch).w[7 as libc::c_int as usize] = b7;
}
unsafe extern "C" fn aes_nohw_inv_sub_bytes(mut batch: *mut AES_NOHW_BATCH) {
...
unsafe extern "C" fn aes_nohw_shift_rows(mut batch: *mut AES_NOHW_BATCH) {
    ...
    while i < 8 as libc::c_int as size_t {
        let mut row0: aes_word_t = aes_nohw_and(
            (*batch).w[i as usize],
            0xf000f000f000f as libc::c_ulong,
        );
        ...
        let mut row2: aes_word_t = aes_nohw_and(
            (*batch).w[i as usize],
            0xf000f000f000f00 as libc::c_ulong,
        );
        let mut row3: aes_word_t = aes_nohw_and(
            (*batch).w[i as usize],
            0xf000f000f000f000 as libc::c_ulong,
        );
        row1 = aes_nohw_or(
            aes_nohw_shift_right(
                row1,
                (1 as libc::c_int * 4 as libc::c_int) as aes_word_t,
            ),
            aes_nohw_shift_left(
                row1,
                (16 as libc::c_int - 1 as libc::c_int * 4 as libc::c_int) as aes_word_t,
            ),
        );
        row2 = aes_nohw_or(
            aes_nohw_shift_right(
                row2,
                (2 as libc::c_int * 4 as libc::c_int) as aes_word_t,
            ),
            aes_nohw_shift_left(
                row2,
                (16 as libc::c_int - 2 as libc::c_int * 4 as libc::c_int) as aes_word_t,
            ),
        );
        row3 = aes_nohw_or(
            aes_nohw_shift_right(
                row3,
                (3 as libc::c_int * 4 as libc::c_int) as aes_word_t,
            ),
            aes_nohw_shift_left(
                row3,
                (16 as libc::c_int - 3 as libc::c_int * 4 as libc::c_int) as aes_word_t,
            ),
        );
        (*batch)
            .w[i
            as usize] = aes_nohw_or(aes_nohw_or(row0, row1), aes_nohw_or(row2, row3));
        i = i.wrapping_add(1);
        i;
    }
}
unsafe extern "C" fn aes_nohw_inv_shift_rows(mut batch: *mut AES_NOHW_BATCH) {
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i < 8 as libc::c_int as size_t {
        let mut row0: aes_word_t = aes_nohw_and(
            (*batch).w[i as usize],
...
unsafe extern "C" fn aes_nohw_rotate_rows_down(mut v: aes_word_t) -> aes_word_t {
    return v >> 4 as libc::c_int & 0xfff0fff0fff0fff as libc::c_ulong
        | v << 12 as libc::c_int & 0xf000f000f000f000 as libc::c_ulong;
}
#[inline]
unsafe extern "C" fn aes_nohw_rotate_rows_twice(mut v: aes_word_t) -> aes_word_t {
    return v >> 8 as libc::c_int & 0xff00ff00ff00ff as libc::c_ulong
        | v << 8 as libc::c_int & 0xff00ff00ff00ff00 as libc::c_ulong;
}
unsafe extern "C" fn aes_nohw_mix_columns(mut batch: *mut AES_NOHW_BATCH) {
    ...
    (*batch)
        .w[0 as libc::c_int
        as usize] = aes_nohw_xor(
        aes_nohw_xor(a7_r7, r0),
        aes_nohw_rotate_rows_twice(a0_r0),
    );
    (*batch)
        .w[1 as libc::c_int
        as usize] = aes_nohw_xor(
    ...
    (*batch)
        .w[2 as libc::c_int
        as usize] = aes_nohw_xor(
        aes_nohw_xor(a1_r1, r2),
        aes_nohw_rotate_rows_twice(a2_r2),
    );
    (*batch)
        .w[3 as libc::c_int
        as usize] = aes_nohw_xor(
    ...
    (*batch)
        ...
        aes_nohw_rotate_rows_twice(a5_r5),
    );
    (*batch)
        .w[6 as libc::c_int
        as usize] = aes_nohw_xor(
        aes_nohw_xor(a5_r5, r6),
        aes_nohw_rotate_rows_twice(a6_r6),
    );
    (*batch)
        .w[7 as libc::c_int
        as usize] = aes_nohw_xor(
        aes_nohw_xor(a6_r6, r7),
        aes_nohw_rotate_rows_twice(a7_r7),
    );
}
unsafe extern "C" fn aes_nohw_inv_mix_columns(mut batch: *mut AES_NOHW_BATCH) {
    let mut a0: aes_word_t = (*batch).w[0 as libc::c_int as usize];
    let mut a1: aes_word_t = (*batch).w[1 as libc::c_int as usize];
    let mut a2: aes_word_t = (*batch).w[2 as libc::c_int as usize];
    let mut a3: aes_word_t = (*batch).w[3 as libc::c_int as usize];
    ...
    let mut a6: aes_word_t = (*batch).w[6 as libc::c_int as usize];
    let mut a7: aes_word_t = (*batch).w[7 as libc::c_int as usize];
    let mut a0_r0: aes_word_t = aes_nohw_xor(a0, aes_nohw_rotate_rows_twice(a0));
    let mut a1_r1: aes_word_t = aes_nohw_xor(a1, aes_nohw_rotate_rows_twice(a1));
    let mut a2_r2: aes_word_t = aes_nohw_xor(a2, aes_nohw_rotate_rows_twice(a2));
    let mut a3_r3: aes_word_t = aes_nohw_xor(a3, aes_nohw_rotate_rows_twice(a3));
    let mut a4_r4: aes_word_t = aes_nohw_xor(a4, aes_nohw_rotate_rows_twice(a4));
    let mut a5_r5: aes_word_t = aes_nohw_xor(a5, aes_nohw_rotate_rows_twice(a5));
    let mut a6_r6: aes_word_t = aes_nohw_xor(a6, aes_nohw_rotate_rows_twice(a6));
    let mut a7_r7: aes_word_t = aes_nohw_xor(a7, aes_nohw_rotate_rows_twice(a7));
    (*batch).w[0 as libc::c_int as usize] = aes_nohw_xor(a0, a6_r6);
    (*batch).w[1 as libc::c_int as usize] = aes_nohw_xor(a1, aes_nohw_xor(a6_r6, a7_r7));
    (*batch).w[2 as libc::c_int as usize] = aes_nohw_xor(a2, aes_nohw_xor(a0_r0, a7_r7));
    (*batch).w[3 as libc::c_int as usize] = aes_nohw_xor(a3, aes_nohw_xor(a1_r1, a6_r6));
    (*batch)
        .w[4 as libc::c_int
        as usize] = aes_nohw_xor(aes_nohw_xor(a4, a2_r2), aes_nohw_xor(a6_r6, a7_r7));
    (*batch).w[5 as libc::c_int as usize] = aes_nohw_xor(a5, aes_nohw_xor(a3_r3, a7_r7));
    (*batch).w[6 as libc::c_int as usize] = aes_nohw_xor(a6, a4_r4);
    (*batch).w[7 as libc::c_int as usize] = aes_nohw_xor(a7, a5_r5);
...
unsafe extern "C" fn aes_nohw_encrypt_batch(
    ...
    aes_nohw_add_round_key(
        batch,
        &*((*key).keys).as_ptr().offset(0 as libc::c_int as isize),
    );
...
unsafe extern "C" fn aes_nohw_decrypt_batch(
    mut key: *const AES_NOHW_SCHEDULE,
    mut num_rounds: size_t,
    mut batch: *mut AES_NOHW_BATCH,
) {
    ...
    let mut i: size_t = num_rounds.wrapping_sub(1 as libc::c_int as size_t);
...
unsafe extern "C" fn aes_nohw_expand_round_keys(
    ...
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i <= (*key).rounds as size_t {
        let mut j: size_t = 0 as libc::c_int as size_t;
        while j < 4 as libc::c_int as size_t {
            let mut tmp: [aes_word_t; 2] = [0; 2];
            memcpy(
                tmp.as_mut_ptr() as *mut libc::c_void,
                ((*key).rd_key)
                    .as_ptr()
                    .offset((4 as libc::c_int as size_t * i) as isize)
...
#[inline]
unsafe extern "C" fn aes_nohw_rcon_slice(
    mut rcon: uint8_t,
    mut i: size_t,
) -> aes_word_t {
    rcon = (rcon as libc::c_int >> i * 4 as libc::c_int as size_t
        & ((1 as libc::c_int) << 4 as libc::c_int) - 1 as libc::c_int) as uint8_t;
    return rcon as aes_word_t;
}
unsafe extern "C" fn aes_nohw_sub_block(
    mut out: *mut aes_word_t,
    mut in_0: *const aes_word_t,
) {
    let mut batch: AES_NOHW_BATCH = AES_NOHW_BATCH { w: [0; 8] };
    memset(
        &mut batch as *mut AES_NOHW_BATCH as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<AES_NOHW_BATCH>() as libc::c_ulong,
    );
    aes_nohw_batch_set(&mut batch, in_0, 0 as libc::c_int as size_t);
    aes_nohw_transpose(&mut batch);
    aes_nohw_sub_bytes(&mut batch);
    aes_nohw_transpose(&mut batch);
    aes_nohw_batch_get(&mut batch, out, 0 as libc::c_int as size_t);
}
unsafe extern "C" fn aes_nohw_setup_key_128(
    mut key: *mut AES_KEY,
    mut in_0: *const uint8_t,
) {
    (*key).rounds = 10 as libc::c_int as libc::c_uint;
    let mut block: [aes_word_t; 2] = [0; 2];
    aes_nohw_compact_block(block.as_mut_ptr(), in_0);
    memcpy(
        ((*key).rd_key).as_mut_ptr() as *mut libc::c_void,
        block.as_mut_ptr() as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong,
    );
    let mut i: size_t = 1 as libc::c_int as size_t;
    while i <= 10 as libc::c_int as size_t {
        let mut sub: [aes_word_t; 2] = [0; 2];
        aes_nohw_sub_block(sub.as_mut_ptr(), block.as_mut_ptr() as *const aes_word_t);
        let mut rcon: uint8_t = aes_nohw_rcon[i.wrapping_sub(1 as libc::c_int as size_t)
            as usize];
        let mut j: size_t = 0 as libc::c_int as size_t;
        while j
            < (16 as libc::c_int as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<aes_word_t>() as libc::c_ulong)
        {
            block[j
                as usize] = aes_nohw_xor(
                block[j as usize],
                aes_nohw_rcon_slice(rcon, j),
            );
            block[j
                as usize] = aes_nohw_xor(
                block[j as usize],
                aes_nohw_shift_right(
                    ...
                    12 as libc::c_int as aes_word_t,
                ),
            );
            ...
            block[j
                as usize] = aes_nohw_xor(
                block[j as usize],
                aes_nohw_shift_left(v, 4 as libc::c_int as aes_word_t),
            );
            block[j
                as usize] = aes_nohw_xor(
                block[j as usize],
                aes_nohw_shift_left(v, 8 as libc::c_int as aes_word_t),
            );
            block[j
                as usize] = aes_nohw_xor(
                block[j as usize],
                aes_nohw_shift_left(v, 12 as libc::c_int as aes_word_t),
            );
            j = j.wrapping_add(1);
            j;
        }
        memcpy(
            ((*key).rd_key)
                .as_mut_ptr()
                .offset((4 as libc::c_int as size_t * i) as isize) as *mut libc::c_void,
            block.as_mut_ptr() as *const libc::c_void,
            16 as libc::c_int as libc::c_ulong,
        );
        i = i.wrapping_add(1);
...
unsafe extern "C" fn aes_nohw_setup_key_192(
    mut key: *mut AES_KEY,
    mut in_0: *const uint8_t,
) {
    (*key).rounds = 12 as libc::c_int as libc::c_uint;
    let mut storage1: [aes_word_t; 2] = [0; 2];
    let mut storage2: [aes_word_t; 2] = [0; 2];
    let mut block1: *mut aes_word_t = storage1.as_mut_ptr();
    let mut block2: *mut aes_word_t = storage2.as_mut_ptr();
    aes_nohw_compact_block(block1, in_0);
    memcpy(
        ((*key).rd_key).as_mut_ptr() as *mut libc::c_void,
        block1 as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong,
    );
    let mut half_block: [uint8_t; 16] = [
    ...
    memcpy(
        half_block.as_mut_ptr() as *mut libc::c_void,
        in_0.offset(16 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong,
    );
    aes_nohw_compact_block(block2, half_block.as_mut_ptr() as *const uint8_t);
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i < 4 as libc::c_int as size_t {
        let mut sub: [aes_word_t; 2] = [0; 2];
        aes_nohw_sub_block(sub.as_mut_ptr(), block2 as *const aes_word_t);
        let mut rcon: uint8_t = aes_nohw_rcon[(2 as libc::c_int as size_t * i) as usize];
        let mut j: size_t = 0 as libc::c_int as size_t;
        while j
            < (16 as libc::c_int as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<aes_word_t>() as libc::c_ulong)
        {
            *block2
                ...
                *block2.offset(j as isize),
                aes_nohw_shift_left(
                    aes_nohw_xor(
                        *block1.offset(j as isize),
                        aes_nohw_rcon_slice(rcon, j),
                    ),
                    8 as libc::c_int as aes_word_t,
                ),
            ...
            *block2
                ...
                *block2.offset(j as isize),
                aes_nohw_and(
                    ...
                    0xffff00000000 as libc::c_ulong,
                ),
            );
            *block2
                .offset(
                ...
                *block2.offset(j as isize),
                aes_nohw_and(
                    ...
                    0xffff000000000000 as libc::c_ulong,
                ),
            );
            *block1
                .offset(
            ...
            *block1
            ...
            let mut v: aes_word_t = *block1.offset(j as isize);
            *block1
                .offset(
                    j as isize,
                ) = aes_nohw_xor(
            ...
            ((*key).rd_key)
                ...
                .offset(
                    (4 as libc::c_int as size_t
                        * (3 as libc::c_int as size_t * i)
                            .wrapping_add(1 as libc::c_int as size_t)) as isize,
                ) as *mut libc::c_void,
            block2 as *const libc::c_void,
            16 as libc::c_int as libc::c_ulong,
        );
        memcpy(
            ((*key).rd_key)
        ...
        aes_nohw_sub_block(sub.as_mut_ptr(), block1 as *const aes_word_t);
        rcon = aes_nohw_rcon[(2 as libc::c_int as size_t * i)
            .wrapping_add(1 as libc::c_int as size_t) as usize];
                ...
                .wrapping_div(::core::mem::size_of::<aes_word_t>() as libc::c_ulong)
        {
            ...
            *block2
                ...
                *block2.offset(j_0 as isize),
                aes_nohw_shift_right(
                    aes_nohw_rotate_rows_down(sub[j_0 as usize]),
                    12 as libc::c_int as aes_word_t,
                ),
            );
            let mut v_0: aes_word_t = *block2.offset(j_0 as isize);
            *block2
                .offset(
                    j_0 as isize,
                ) = aes_nohw_xor(
                *block2.offset(j_0 as isize),
                aes_nohw_shift_left(v_0, 4 as libc::c_int as aes_word_t),
            );
            *block2
                .offset(
                    j_0 as isize,
                ...
                *block2.offset(j_0 as isize),
                aes_nohw_shift_left(v_0, 8 as libc::c_int as aes_word_t),
            );
            *block2
                .offset(
                    j_0 as isize,
                ...
                *block2.offset(j_0 as isize),
                aes_nohw_shift_left(v_0, 12 as libc::c_int as aes_word_t),
            );
            *block1
                .offset(
                    j_0 as isize,
        ...
        let mut tmp: *mut aes_word_t = block1;
        block1 = block2;
        block2 = tmp;
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn aes_nohw_setup_key_256(
    mut key: *mut AES_KEY,
    mut in_0: *const uint8_t,
) {
    (*key).rounds = 14 as libc::c_int as libc::c_uint;
    let mut block1: [aes_word_t; 2] = [0; 2];
    let mut block2: [aes_word_t; 2] = [0; 2];
    aes_nohw_compact_block(block1.as_mut_ptr(), in_0);
    memcpy(
        ((*key).rd_key).as_mut_ptr() as *mut libc::c_void,
        block1.as_mut_ptr() as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong,
    );
    aes_nohw_compact_block(block2.as_mut_ptr(), in_0.offset(16 as libc::c_int as isize));
    memcpy(
        ((*key).rd_key).as_mut_ptr().offset(4 as libc::c_int as isize)
            as *mut libc::c_void,
        block2.as_mut_ptr() as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong,
    );
    ...
    while i <= 14 as libc::c_int as size_t {
        ...
        let mut rcon: uint8_t = aes_nohw_rcon[(i / 2 as libc::c_int as size_t)
        ...
        if i == 14 as libc::c_int as size_t {
            break;
        }
                ...
                .wrapping_div(::core::mem::size_of::<aes_word_t>() as libc::c_ulong)
        {
            block2[j_0
                as usize] = aes_nohw_xor(
                block2[j_0 as usize],
                aes_nohw_shift_right(sub[j_0 as usize], 12 as libc::c_int as aes_word_t),
            );
...
pub unsafe extern "C" fn aes_nohw_encrypt(
    ...
    let mut batch: AES_NOHW_BATCH = AES_NOHW_BATCH { w: [0; 8] };
    aes_nohw_to_batch(&mut batch, in_0, 1 as libc::c_int as size_t);
...
pub unsafe extern "C" fn aes_nohw_decrypt(
    ...
    let mut batch: AES_NOHW_BATCH = AES_NOHW_BATCH { w: [0; 8] };
    aes_nohw_to_batch(&mut batch, in_0, 1 as libc::c_int as size_t);
    aes_nohw_decrypt_batch(&mut sched, (*key).rounds as size_t, &mut batch);
    aes_nohw_from_batch(out, 1 as libc::c_int as size_t, &mut batch);
}
#[inline]
unsafe extern "C" fn aes_nohw_xor_block(
    ...
    while i < 16 as libc::c_int as size_t {
        ...
        memcpy(
            &mut x as *mut aes_word_t as *mut libc::c_void,
            a.offset(i as isize) as *const libc::c_void,
            ::core::mem::size_of::<aes_word_t>() as libc::c_ulong,
        );
        memcpy(
            &mut y as *mut aes_word_t as *mut libc::c_void,
            b.offset(i as isize) as *const libc::c_void,
            ::core::mem::size_of::<aes_word_t>() as libc::c_ulong,
        );
        x = aes_nohw_xor(x, y);
        memcpy(
            out.offset(i as isize) as *mut libc::c_void,
            &mut x as *mut aes_word_t as *const libc::c_void,
            ::core::mem::size_of::<aes_word_t>() as libc::c_ulong,
        );
        i = (i as libc::c_ulong)
            .wrapping_add(::core::mem::size_of::<aes_word_t>() as libc::c_ulong)
            as size_t as size_t;
    }
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aes_nohw_ctr32_encrypt_blocks(
    ...
    if blocks == 0 as libc::c_int as size_t {
        return;
    }
    let mut sched: AES_NOHW_SCHEDULE = AES_NOHW_SCHEDULE {
        keys: [AES_NOHW_BATCH { w: [0; 8] }; 15],
    ...
    aes_nohw_expand_round_keys(&mut sched, key);
    let mut ivs: [uint8_t; 64] = [0; 64];
    let mut enc_ivs: [uint8_t; 64] = [0; 64];
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i < 4 as libc::c_int as size_t {
        memcpy(
            ivs.as_mut_ptr().offset((16 as libc::c_int as size_t * i) as isize)
                as *mut libc::c_void,
    ...
    let mut ctr: uint32_t = CRYPTO_load_u32_be(
        ivs.as_mut_ptr().offset(12 as libc::c_int as isize) as *const libc::c_void,
    );
    loop {
        let mut i_0: size_t = 0 as libc::c_int as size_t;
        while i_0 < 4 as libc::c_int as size_t {
            CRYPTO_store_u32_be(
                ivs
                    .as_mut_ptr()
                    .offset((16 as libc::c_int as size_t * i_0) as isize)
                    .offset(12 as libc::c_int as isize) as *mut libc::c_void,
                ctr.wrapping_add(i_0 as uint32_t),
            );
            i_0 = i_0.wrapping_add(1);
            i_0;
        }
        let mut todo: size_t = if blocks >= 4 as libc::c_int as size_t {
            4 as libc::c_int as size_t
        } else {
            blocks
        };
        let mut batch: AES_NOHW_BATCH = AES_NOHW_BATCH { w: [0; 8] };
        aes_nohw_to_batch(&mut batch, ivs.as_mut_ptr(), todo);
        aes_nohw_encrypt_batch(&mut sched, (*key).rounds as size_t, &mut batch);
        aes_nohw_from_batch(enc_ivs.as_mut_ptr(), todo, &mut batch);
        let mut i_1: size_t = 0 as libc::c_int as size_t;
        while i_1 < todo {
            aes_nohw_xor_block(
                out.offset((16 as libc::c_int as size_t * i_1) as isize),
                in_0.offset((16 as libc::c_int as size_t * i_1) as isize),
                enc_ivs.as_mut_ptr().offset((16 as libc::c_int as size_t * i_1) as isize)
                    as *const uint8_t,
            );
            i_1 = i_1.wrapping_add(1);
            i_1;
        }
        blocks = blocks.wrapping_sub(todo);
        if blocks == 0 as libc::c_int as size_t {
            break;
        }
        in_0 = in_0.offset((16 as libc::c_int * 4 as libc::c_int) as isize);
        out = out.offset((16 as libc::c_int * 4 as libc::c_int) as isize);
...
pub unsafe extern "C" fn aes_nohw_cbc_encrypt(
    ...
    if len % 16 as libc::c_int as size_t == 0 as libc::c_int as size_t {} else {
        __assert_fail(
            b"len % 16 == 0\0" as *const u8 as *const libc::c_char,
            b"/home/ubuntu/workspace/oss/aws-lc/crypto/fipsmodule/aes/aes_nohw.c\0"
                as *const u8 as *const libc::c_char,
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 101],
            >(
                b"void aes_nohw_cbc_encrypt(const uint8_t *, uint8_t *, size_t, const AES_KEY *, uint8_t *, const int)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    if enc != 0 {
        while blocks > 0 as libc::c_int as size_t {
            aes_nohw_xor_block(iv.as_mut_ptr(), iv.as_mut_ptr() as *const uint8_t, in_0);
            let mut batch: AES_NOHW_BATCH = AES_NOHW_BATCH { w: [0; 8] };
            aes_nohw_to_batch(&mut batch, iv.as_mut_ptr(), 1 as libc::c_int as size_t);
            aes_nohw_encrypt_batch(&mut sched, (*key).rounds as size_t, &mut batch);
            aes_nohw_from_batch(out, 1 as libc::c_int as size_t, &mut batch);
            memcpy(
                iv.as_mut_ptr() as *mut libc::c_void,
    ...
    loop {
        ...
        let mut copy: [uint8_t; 64] = [0; 64];
        memcpy(
            copy.as_mut_ptr() as *mut libc::c_void,
            in_0 as *const libc::c_void,
            todo * 16 as libc::c_int as size_t,
        );
        let mut batch_0: AES_NOHW_BATCH = AES_NOHW_BATCH { w: [0; 8] };
        aes_nohw_to_batch(&mut batch_0, in_0, todo);
        aes_nohw_decrypt_batch(&mut sched, (*key).rounds as size_t, &mut batch_0);
        aes_nohw_from_batch(out, todo, &mut batch_0);
        aes_nohw_xor_block(
            out,
            out as *const uint8_t,
            iv.as_mut_ptr() as *const uint8_t,
        );
        let mut i: size_t = 1 as libc::c_int as size_t;
        while i < todo {
            aes_nohw_xor_block(
                out.offset((16 as libc::c_int as size_t * i) as isize),
                out.offset((16 as libc::c_int as size_t * i) as isize) as *const uint8_t,
                copy
                    .as_mut_ptr()
                    .offset(
        ...
        memcpy(
            ...
            copy
                ...
                .offset(
                    (16 as libc::c_int as size_t
                        * todo.wrapping_sub(1 as libc::c_int as size_t)) as isize,
                ) as *const libc::c_void,
            16 as libc::c_int as libc::c_ulong,
        );
        blocks = blocks.wrapping_sub(todo);
