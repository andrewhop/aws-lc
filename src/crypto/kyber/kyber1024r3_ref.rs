...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_compress(
    mut r: *mut uint8_t,
    mut a: *const poly,
) {
    ...
    while i < (256 as libc::c_int / 8 as libc::c_int) as libc::c_uint {
        ...
        while j < 8 as libc::c_int as libc::c_uint {
            ...
            u = (u as libc::c_int
                ...
                as int16_t;
            d0 = ((u as libc::c_int) << 5 as libc::c_int) as uint32_t;
            d0 = d0.wrapping_add(1664 as libc::c_int as uint32_t);
            d0 = d0 * 40318 as libc::c_int as uint32_t;
            d0 >>= 27 as libc::c_int;
            t[j as usize] = (d0 & 0x1f as libc::c_int as uint32_t) as uint8_t;
            j = j.wrapping_add(1);
            j;
        }
        *r
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_decompress(
    mut r: *mut poly,
    mut a: *const uint8_t,
) {
    let mut i: libc::c_uint = 0;
    ...
    while i < (256 as libc::c_int / 8 as libc::c_int) as libc::c_uint {
        ...
        t[3 as libc::c_int
            as usize] = (*a.offset(1 as libc::c_int as isize) as libc::c_int
            >> 7 as libc::c_int
            | (*a.offset(2 as libc::c_int as isize) as libc::c_int) << 1 as libc::c_int)
            as uint8_t;
        t[4 as libc::c_int
            as usize] = (*a.offset(2 as libc::c_int as isize) as libc::c_int
            >> 4 as libc::c_int
            | (*a.offset(3 as libc::c_int as isize) as libc::c_int) << 4 as libc::c_int)
            as uint8_t;
        t[5 as libc::c_int
        ...
        t[6 as libc::c_int
            as usize] = (*a.offset(3 as libc::c_int as isize) as libc::c_int
            >> 6 as libc::c_int
            | (*a.offset(4 as libc::c_int as isize) as libc::c_int) << 2 as libc::c_int)
            as uint8_t;
        t[7 as libc::c_int
            as usize] = (*a.offset(4 as libc::c_int as isize) as libc::c_int
        ...
        while j < 8 as libc::c_int as libc::c_uint {
            (*r)
                ...
                .wrapping_mul(i)
                .wrapping_add(j)
                as usize] = (((t[j as usize] as libc::c_int & 31 as libc::c_int)
                as uint32_t * 3329 as libc::c_int as uint32_t)
                .wrapping_add(16 as libc::c_int as uint32_t) >> 5 as libc::c_int)
                as int16_t;
            j = j.wrapping_add(1);
            j;
        }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_tobytes(
    mut r: *mut uint8_t,
    mut a: *const poly,
) {
    let mut i: libc::c_uint = 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_frombytes(
    mut r: *mut poly,
    mut a: *const uint8_t,
) {
    let mut i: libc::c_uint = 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_frommsg(
    mut r: *mut poly,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_tomsg(
    mut msg: *mut uint8_t,
    mut a: *const poly,
) {
    let mut i: libc::c_uint = 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_getnoise_eta1(
    mut r: *mut poly,
    mut seed: *const uint8_t,
    mut nonce: uint8_t,
) {
    let mut buf: [uint8_t; 128] = [0; 128];
    pqcrystals_kyber1024_ref_kyber_shake256_prf(
        buf.as_mut_ptr(),
        ::core::mem::size_of::<[uint8_t; 128]>() as libc::c_ulong,
        seed,
        nonce,
    );
    pqcrystals_kyber1024_ref_poly_cbd_eta1(r, buf.as_mut_ptr() as *const uint8_t);
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_getnoise_eta2(
    mut r: *mut poly,
    mut seed: *const uint8_t,
    mut nonce: uint8_t,
) {
    ...
    pqcrystals_kyber1024_ref_poly_cbd_eta2(r, buf.as_mut_ptr() as *const uint8_t);
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_ntt(mut r: *mut poly) {
    pqcrystals_kyber1024_ref_ntt(((*r).coeffs).as_mut_ptr());
    pqcrystals_kyber1024_ref_poly_reduce(r);
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_invntt_tomont(mut r: *mut poly) {
    pqcrystals_kyber1024_ref_invntt(((*r).coeffs).as_mut_ptr());
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_basemul_montgomery(
    mut r: *mut poly,
    mut a: *const poly,
    mut b: *const poly,
) {
    ...
    while i < (256 as libc::c_int / 4 as libc::c_int) as libc::c_uint {
        pqcrystals_kyber1024_ref_basemul(
            ...
            &*((*b).coeffs)
                .as_ptr()
                .offset((4 as libc::c_int as libc::c_uint).wrapping_mul(i) as isize),
            pqcrystals_kyber1024_ref_zetas[(64 as libc::c_int as libc::c_uint)
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_tomont(mut r: *mut poly) {
    let mut i: libc::c_uint = 0;
    ...
    while i < 256 as libc::c_int as libc::c_uint {
        (*r)
            .coeffs[i
            as usize] = pqcrystals_kyber1024_ref_montgomery_reduce(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_reduce(mut r: *mut poly) {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < 256 as libc::c_int as libc::c_uint {
        (*r)
            .coeffs[i
            as usize] = pqcrystals_kyber1024_ref_barrett_reduce((*r).coeffs[i as usize]);
        i = i.wrapping_add(1);
        i;
    }
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_add(
    mut r: *mut poly,
    mut a: *const poly,
    mut b: *const poly,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_sub(
    mut r: *mut poly,
    mut a: *const poly,
    mut b: *const poly,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_cbd_eta1(
    mut r: *mut poly,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_poly_cbd_eta2(
    mut r: *mut poly,
    mut buf: *const uint8_t,
) {
    cbd2(r, buf);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_compress(
    mut r: *mut uint8_t,
    mut a: *const polyvec,
) {
    let mut i: libc::c_uint = 0;
    ...
    while i < 4 as libc::c_int as libc::c_uint {
        ...
        while j < (256 as libc::c_int / 8 as libc::c_int) as libc::c_uint {
            ...
            while k < 8 as libc::c_int as libc::c_uint {
                ...
                d0 <<= 11 as libc::c_int;
                d0 = d0.wrapping_add(1664 as libc::c_int as uint64_t);
                d0 = d0 * 645084 as libc::c_int as uint64_t;
                d0 >>= 31 as libc::c_int;
                t[k as usize] = (d0 & 0x7ff as libc::c_int as uint64_t) as uint16_t;
                k = k.wrapping_add(1);
                k;
            }
            *r
            ...
            *r
                ...
                as uint8_t;
            r = r.offset(11 as libc::c_int as isize);
            j = j.wrapping_add(1);
            j;
        }
        i = i.wrapping_add(1);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_decompress(
    mut r: *mut polyvec,
    mut a: *const uint8_t,
) {
    let mut i: libc::c_uint = 0;
    ...
    while i < 4 as libc::c_int as libc::c_uint {
        ...
        while j < (256 as libc::c_int / 8 as libc::c_int) as libc::c_uint {
            ...
            t[3 as libc::c_int
                as usize] = (*a.offset(4 as libc::c_int as isize) as libc::c_int
                >> 1 as libc::c_int
                | (*a.offset(5 as libc::c_int as isize) as uint16_t as libc::c_int)
                    << 7 as libc::c_int) as uint16_t;
            t[4 as libc::c_int
                as usize] = (*a.offset(5 as libc::c_int as isize) as libc::c_int
                >> 4 as libc::c_int
                | (*a.offset(6 as libc::c_int as isize) as uint16_t as libc::c_int)
                    << 4 as libc::c_int) as uint16_t;
            t[5 as libc::c_int
                as usize] = (*a.offset(6 as libc::c_int as isize) as libc::c_int
                >> 7 as libc::c_int
                | (*a.offset(7 as libc::c_int as isize) as uint16_t as libc::c_int)
                    << 1 as libc::c_int
                | (*a.offset(8 as libc::c_int as isize) as uint16_t as libc::c_int)
                    << 9 as libc::c_int) as uint16_t;
            t[6 as libc::c_int
                as usize] = (*a.offset(8 as libc::c_int as isize) as libc::c_int
                >> 2 as libc::c_int
                | (*a.offset(9 as libc::c_int as isize) as uint16_t as libc::c_int)
                    << 6 as libc::c_int) as uint16_t;
            t[7 as libc::c_int
                as usize] = (*a.offset(9 as libc::c_int as isize) as libc::c_int
                >> 5 as libc::c_int
                | (*a.offset(10 as libc::c_int as isize) as uint16_t as libc::c_int)
                    << 3 as libc::c_int) as uint16_t;
            a = a.offset(11 as libc::c_int as isize);
            k = 0 as libc::c_int as libc::c_uint;
            while k < 8 as libc::c_int as libc::c_uint {
                (*r)
                    .vec[i as usize]
                    ...
                    .wrapping_mul(j)
                    .wrapping_add(k)
                    as usize] = (((t[k as usize] as libc::c_int & 0x7ff as libc::c_int)
                    as uint32_t * 3329 as libc::c_int as uint32_t)
                    .wrapping_add(1024 as libc::c_int as uint32_t) >> 11 as libc::c_int)
                    as int16_t;
                k = k.wrapping_add(1);
                k;
            }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_tobytes(
    mut r: *mut uint8_t,
    mut a: *const polyvec,
) {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        pqcrystals_kyber1024_ref_poly_tobytes(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_frombytes(
    mut r: *mut polyvec,
    mut a: *const uint8_t,
) {
    let mut i: libc::c_uint = 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_ntt(mut r: *mut polyvec) {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        pqcrystals_kyber1024_ref_poly_ntt(
            &mut *((*r).vec).as_mut_ptr().offset(i as isize),
        );
        i = i.wrapping_add(1);
        i;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_invntt_tomont(
    mut r: *mut polyvec,
) {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        pqcrystals_kyber1024_ref_poly_invntt_tomont(
            &mut *((*r).vec).as_mut_ptr().offset(i as isize),
        );
        i = i.wrapping_add(1);
        i;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_basemul_acc_montgomery(
    mut r: *mut poly,
    mut a: *const polyvec,
    mut b: *const polyvec,
) {
    ...
    pqcrystals_kyber1024_ref_poly_basemul_montgomery(
        r,
    ...
    while i < 4 as libc::c_int as libc::c_uint {
        ...
        pqcrystals_kyber1024_ref_poly_add(r, r, &mut t);
        i = i.wrapping_add(1);
        i;
    }
    pqcrystals_kyber1024_ref_poly_reduce(r);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_reduce(mut r: *mut polyvec) {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        pqcrystals_kyber1024_ref_poly_reduce(
            &mut *((*r).vec).as_mut_ptr().offset(i as isize),
        );
        i = i.wrapping_add(1);
        i;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_polyvec_add(
    mut r: *mut polyvec,
    mut a: *const polyvec,
    mut b: *const polyvec,
) {
    ...
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        pqcrystals_kyber1024_ref_poly_add(
            &mut *((*r).vec).as_mut_ptr().offset(i as isize),
            &*((*a).vec).as_ptr().offset(i as isize),
            &*((*b).vec).as_ptr().offset(i as isize),
        );
...
unsafe extern "C" fn pack_pk(
    ...
    let mut i: size_t = 0;
    pqcrystals_kyber1024_ref_polyvec_tobytes(r, pk);
    i = 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as size_t {
        *r
            .offset(
                i.wrapping_add((4 as libc::c_int * 384 as libc::c_int) as size_t)
                    as isize,
...
unsafe extern "C" fn unpack_pk(
    ...
    let mut i: size_t = 0;
    pqcrystals_kyber1024_ref_polyvec_frombytes(pk, packedpk);
    i = 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as size_t {
        *seed
            .offset(
...
unsafe extern "C" fn pack_sk(mut r: *mut uint8_t, mut sk: *mut polyvec) {
    pqcrystals_kyber1024_ref_polyvec_tobytes(r, sk);
}
unsafe extern "C" fn unpack_sk(mut sk: *mut polyvec, mut packedsk: *const uint8_t) {
    pqcrystals_kyber1024_ref_polyvec_frombytes(sk, packedsk);
}
unsafe extern "C" fn pack_ciphertext(
    ...
    pqcrystals_kyber1024_ref_polyvec_compress(r, b);
    pqcrystals_kyber1024_ref_poly_compress(
...
unsafe extern "C" fn unpack_ciphertext(
    ...
    pqcrystals_kyber1024_ref_polyvec_decompress(b, c);
    pqcrystals_kyber1024_ref_poly_decompress(
        v,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_gen_matrix(
    mut a: *mut polyvec,
    mut seed: *const uint8_t,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_indcpa_keypair_derand(
    mut pk: *mut uint8_t,
    mut sk: *mut uint8_t,
    ...
    let mut a: [polyvec; 4] = [polyvec {
        vec: [poly { coeffs: [0; 256] }; 4],
    }; 4];
    ...
    pqcrystals_kyber1024_ref_gen_matrix(a.as_mut_ptr(), publicseed, 0 as libc::c_int);
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        let fresh3 = nonce;
        nonce = nonce.wrapping_add(1);
        pqcrystals_kyber1024_ref_poly_getnoise_eta1(
    ...
    pqcrystals_kyber1024_ref_polyvec_ntt(&mut skpv);
    pqcrystals_kyber1024_ref_polyvec_ntt(&mut e);
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        pqcrystals_kyber1024_ref_polyvec_basemul_acc_montgomery(
            &mut *(pkpv.vec).as_mut_ptr().offset(i as isize),
            &mut *a.as_mut_ptr().offset(i as isize),
            &mut skpv,
        );
        pqcrystals_kyber1024_ref_poly_tomont(
            &mut *(pkpv.vec).as_mut_ptr().offset(i as isize),
        );
        i = i.wrapping_add(1);
        i;
    }
    pqcrystals_kyber1024_ref_polyvec_add(&mut pkpv, &mut pkpv, &mut e);
    pqcrystals_kyber1024_ref_polyvec_reduce(&mut pkpv);
    pack_sk(sk, &mut skpv);
    pack_pk(pk, &mut pkpv, publicseed);
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_indcpa_enc(
    mut c: *mut uint8_t,
    mut m: *const uint8_t,
    ...
    pqcrystals_kyber1024_ref_poly_frommsg(&mut k, m);
    pqcrystals_kyber1024_ref_gen_matrix(
        at.as_mut_ptr(),
    ...
    while i < 4 as libc::c_int as libc::c_uint {
        let fresh6 = nonce;
        nonce = nonce.wrapping_add(1);
        pqcrystals_kyber1024_ref_poly_getnoise_eta2(
    ...
    let fresh7 = nonce;
    nonce = nonce.wrapping_add(1);
    pqcrystals_kyber1024_ref_poly_getnoise_eta2(&mut epp, coins, fresh7);
    pqcrystals_kyber1024_ref_polyvec_ntt(&mut sp);
    i = 0 as libc::c_int as libc::c_uint;
    while i < 4 as libc::c_int as libc::c_uint {
        pqcrystals_kyber1024_ref_polyvec_basemul_acc_montgomery(
    ...
    pqcrystals_kyber1024_ref_polyvec_basemul_acc_montgomery(&mut v, &mut pkpv, &mut sp);
    pqcrystals_kyber1024_ref_polyvec_invntt_tomont(&mut b);
    pqcrystals_kyber1024_ref_poly_invntt_tomont(&mut v);
    pqcrystals_kyber1024_ref_polyvec_add(&mut b, &mut b, &mut ep);
    pqcrystals_kyber1024_ref_poly_add(&mut v, &mut v, &mut epp);
    pqcrystals_kyber1024_ref_poly_add(&mut v, &mut v, &mut k);
    pqcrystals_kyber1024_ref_polyvec_reduce(&mut b);
    pqcrystals_kyber1024_ref_poly_reduce(&mut v);
    pack_ciphertext(c, &mut b, &mut v);
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_indcpa_dec(
    mut m: *mut uint8_t,
    mut c: *const uint8_t,
    ...
    pqcrystals_kyber1024_ref_polyvec_ntt(&mut b);
    pqcrystals_kyber1024_ref_polyvec_basemul_acc_montgomery(&mut mp, &mut skpv, &mut b);
    pqcrystals_kyber1024_ref_poly_invntt_tomont(&mut mp);
    pqcrystals_kyber1024_ref_poly_sub(&mut mp, &mut v, &mut mp);
    pqcrystals_kyber1024_ref_poly_reduce(&mut mp);
    pqcrystals_kyber1024_ref_poly_tomsg(m, &mut mp);
}
#[unsafe(no_mangle)]
pub static mut pqcrystals_kyber1024_ref_zetas: [int16_t; 128] = [
...
unsafe extern "C" fn fqmul(mut a: int16_t, mut b: int16_t) -> int16_t {
    return pqcrystals_kyber1024_ref_montgomery_reduce(a as int32_t * b as libc::c_int);
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_ntt(mut r: *mut int16_t) {
    ...
    while len >= 2 as libc::c_int as libc::c_uint {
        ...
        while start < 256 as libc::c_int as libc::c_uint {
            let fresh8 = k;
            k = k.wrapping_add(1);
            zeta = pqcrystals_kyber1024_ref_zetas[fresh8 as usize];
            j = start;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_invntt(mut r: *mut int16_t) {
    let mut start: libc::c_uint = 0;
    let mut len: libc::c_uint = 0;
    let mut j: libc::c_uint = 0;
    let mut k: libc::c_uint = 0;
    ...
    while len <= 128 as libc::c_int as libc::c_uint {
        ...
        while start < 256 as libc::c_int as libc::c_uint {
            let fresh9 = k;
            k = k.wrapping_sub(1);
            zeta = pqcrystals_kyber1024_ref_zetas[fresh9 as usize];
            j = start;
            while j < start.wrapping_add(len) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_basemul(
    mut r: *mut int16_t,
    mut a: *const int16_t,
    mut b: *const int16_t,
    mut zeta: int16_t,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_kyber_shake128_absorb(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_kyber_shake256_prf(
    mut out: *mut uint8_t,
    mut outlen: size_t,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_keypair_derand(
    mut pk: *mut uint8_t,
    mut sk: *mut uint8_t,
    mut coins: *const uint8_t,
) -> libc::c_int {
    pqcrystals_kyber1024_ref_indcpa_keypair_derand(pk, sk, coins);
    memcpy(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_keypair(
    mut pk: *mut uint8_t,
    mut sk: *mut uint8_t,
) -> libc::c_int {
    ...
    pqcrystals_kyber1024_ref_keypair_derand(
        pk,
        sk,
        coins.as_mut_ptr() as *const uint8_t,
    );
    return 0 as libc::c_int;
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_enc_derand(
    mut ct: *mut uint8_t,
    mut ss: *mut uint8_t,
    mut pk: *const uint8_t,
    mut coins: *const uint8_t,
    ...
    pqcrystals_kyber1024_ref_indcpa_enc(
        ct,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_enc(
    mut ct: *mut uint8_t,
    mut ss: *mut uint8_t,
    mut pk: *const uint8_t,
) -> libc::c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_dec(
    mut ss: *mut uint8_t,
    ...
    let mut buf: [uint8_t; 64] = [0; 64];
    let mut kr: [uint8_t; 64] = [0; 64];
    let mut cmp: [uint8_t; 1568] = [0; 1568];
    let mut pk: *const uint8_t = sk
        .offset((4 as libc::c_int * 384 as libc::c_int) as isize);
    pqcrystals_kyber1024_ref_indcpa_dec(buf.as_mut_ptr(), ct, sk);
    i = 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as size_t {
    ...
    fail = pqcrystals_kyber1024_ref_verify(
        ct,
        cmp.as_mut_ptr(),
        (4 as libc::c_int * 352 as libc::c_int + 160 as libc::c_int) as size_t,
    );
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_verify(
    mut a: *const uint8_t,
    mut b: *const uint8_t,
    mut len: size_t,
) -> libc::c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_cmov(
    mut r: *mut uint8_t,
    mut x: *const uint8_t,
    mut len: size_t,
    mut b: uint8_t,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_montgomery_reduce(
    mut a: int32_t,
) -> int16_t {
    let mut t: int16_t = 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn pqcrystals_kyber1024_ref_barrett_reduce(
    mut a: int16_t,
) -> int16_t {
    let mut t: int16_t = 0;
