...
static mut AUTHORITY_KEYID_seq_tt: [ASN1_TEMPLATE; 3] = unsafe {
    [
        {
...
pub unsafe extern "C" fn d2i_AUTHORITY_KEYID(
    ...
    return ASN1_item_d2i(a as *mut *mut ASN1_VALUE, in_0, len, &AUTHORITY_KEYID_it)
...
unsafe extern "C" fn run_static_initializers() {
    AUTHORITY_KEYID_it = {
        let mut init = ASN1_ITEM_st {
            ...
            templates: AUTHORITY_KEYID_seq_tt.as_ptr(),
            tcount: (::core::mem::size_of::<[ASN1_TEMPLATE; 3]>() as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<ASN1_TEMPLATE>() as libc::c_ulong)
                as libc::c_long,
            funcs: 0 as *const libc::c_void,
            size: ::core::mem::size_of::<AUTHORITY_KEYID>() as libc::c_ulong
                as libc::c_long,
            sname: b"AUTHORITY_KEYID\0" as *const u8 as *const libc::c_char,
        };
        init
    };
}
