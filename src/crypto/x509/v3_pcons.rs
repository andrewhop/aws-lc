...
#[unsafe(no_mangle)]
pub static mut v3_policy_constraints: X509V3_EXT_METHOD = unsafe {
    {
        let mut init = v3_ext_method {
            ext_nid: 401 as libc::c_int,
            ext_flags: 0 as libc::c_int,
            it: &POLICY_CONSTRAINTS_it as *const ASN1_ITEM,
            ext_new: None,
            ext_free: None,
            d2i: None,
            i2d: None,
...
static mut POLICY_CONSTRAINTS_seq_tt: [ASN1_TEMPLATE; 2] = unsafe {
    [
        {
            let mut init = ASN1_TEMPLATE_st {
                ...
                field_name: b"requireExplicitPolicy\0" as *const u8
        ...
        },
        {
            let mut init = ASN1_TEMPLATE_st {
                ...
                field_name: b"inhibitPolicyMapping\0" as *const u8
                    as *const libc::c_char,
                item: &ASN1_INTEGER_it as *const ASN1_ITEM,
            };
            init
...
#[unsafe(no_mangle)]
pub static mut POLICY_CONSTRAINTS_it: ASN1_ITEM = ASN1_ITEM_st {
    itype: 0,
    utype: 0,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn POLICY_CONSTRAINTS_free(mut a: *mut POLICY_CONSTRAINTS) {
    ASN1_item_free(a as *mut ASN1_VALUE, &POLICY_CONSTRAINTS_it);
}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn POLICY_CONSTRAINTS_new() -> *mut POLICY_CONSTRAINTS {
    return ASN1_item_new(&POLICY_CONSTRAINTS_it) as *mut POLICY_CONSTRAINTS;
}
unsafe extern "C" fn i2v_POLICY_CONSTRAINTS(
    ...
    let mut pcons: *const POLICY_CONSTRAINTS = a as *const POLICY_CONSTRAINTS;
    X509V3_add_value_int(
        b"Require Explicit Policy\0" as *const u8 as *const libc::c_char,
        (*pcons).requireExplicitPolicy,
        &mut extlist,
    );
    X509V3_add_value_int(
        b"Inhibit Policy Mapping\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn v2i_POLICY_CONSTRAINTS(
    ...
    let mut pcons: *mut POLICY_CONSTRAINTS = 0 as *mut POLICY_CONSTRAINTS;
    ...
    loop {
        ...
        if strcmp(
            (*val).name,
            b"requireExplicitPolicy\0" as *const u8 as *const libc::c_char,
        ) == 0
        {
            if X509V3_get_value_int(val, &mut (*pcons).requireExplicitPolicy) == 0 {
                current_block = 13845736229122314675;
                break;
            }
        } else if strcmp(
            (*val).name,
            b"inhibitPolicyMapping\0" as *const u8 as *const libc::c_char,
        ) == 0
        {
            if X509V3_get_value_int(val, &mut (*pcons).inhibitPolicyMapping) == 0 {
                current_block = 13845736229122314675;
                break;
            }
        } else {
            ERR_put_error(
                ...
                0 as libc::c_int,
                123 as libc::c_int,
                b"/home/ubuntu/workspace/oss/aws-lc/crypto/x509/v3_pcons.c\0"
    ...
    match current_block {
        12800627514080957624 => {
            if ((*pcons).inhibitPolicyMapping).is_null()
                && ((*pcons).requireExplicitPolicy).is_null()
            {
                ERR_put_error(
                    20 as libc::c_int,
                    0 as libc::c_int,
                ...
                return pcons as *mut libc::c_void
            }
        }
        _ => {}
    }
...
unsafe extern "C" fn run_static_initializers() {
    POLICY_CONSTRAINTS_it = {
        let mut init = ASN1_ITEM_st {
            ...
            templates: POLICY_CONSTRAINTS_seq_tt.as_ptr(),
            tcount: (::core::mem::size_of::<[ASN1_TEMPLATE; 2]>() as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<ASN1_TEMPLATE>() as libc::c_ulong)
                as libc::c_long,
            funcs: 0 as *const libc::c_void,
            size: ::core::mem::size_of::<POLICY_CONSTRAINTS>() as libc::c_ulong
                as libc::c_long,
            sname: b"POLICY_CONSTRAINTS\0" as *const u8 as *const libc::c_char,
        };
        init
    };
}
