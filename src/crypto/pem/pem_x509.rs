...
unsafe extern "C" fn pem_read_X509_d2i(
...
unsafe extern "C" fn pem_write_bio_X509_i2d(
...
unsafe extern "C" fn pem_write_X509_i2d(
    mut x: *const libc::c_void,
    mut outp: *mut *mut libc::c_uchar,
) -> libc::c_int {
    return i2d_X509(x as *mut X509, outp);
}
unsafe extern "C" fn pem_read_bio_X509_d2i(
    mut x: *mut *mut libc::c_void,
    mut inp: *mut *const libc::c_uchar,
    mut len: libc::c_long,
) -> *mut libc::c_void {
