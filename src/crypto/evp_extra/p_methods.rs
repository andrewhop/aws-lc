...
unsafe extern "C" {
    ...
    pub type kem_key_st;
    pub type rsa_st;
    static dsa_asn1_meth: EVP_PKEY_ASN1_METHOD;
    static ec_asn1_meth: EVP_PKEY_ASN1_METHOD;
    static rsa_asn1_meth: EVP_PKEY_ASN1_METHOD;
    static rsa_pss_asn1_meth: EVP_PKEY_ASN1_METHOD;
    ...
    static dh_asn1_meth: EVP_PKEY_ASN1_METHOD;
    static ed25519ph_asn1_meth: EVP_PKEY_ASN1_METHOD;
    static x25519_pkey_meth: EVP_PKEY_METHOD;
    static dh_pkey_meth: EVP_PKEY_METHOD;
    static dsa_pkey_meth: EVP_PKEY_METHOD;
}
...
static mut non_fips_pkey_evp_methods: [*const EVP_PKEY_METHOD; 3] = unsafe {
    [
        &x25519_pkey_meth as *const EVP_PKEY_METHOD,
        &dh_pkey_meth as *const EVP_PKEY_METHOD,
...
pub static mut asn1_evp_pkey_methods: [*const EVP_PKEY_ASN1_METHOD; 11] = unsafe {
    [
        ...
        &rsa_pss_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &ec_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &dsa_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &ed25519_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &x25519_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &pqdsa_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &kem_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &hmac_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
        &dh_asn1_meth as *const EVP_PKEY_ASN1_METHOD,
...
unsafe extern "C" fn run_static_initializers() {
    asn1_evp_pkey_methods_size = (::core::mem::size_of::<
        [*const EVP_PKEY_ASN1_METHOD; 11],
    >() as libc::c_ulong)
        .wrapping_div(
            ::core::mem::size_of::<*const EVP_PKEY_ASN1_METHOD>() as libc::c_ulong,
        );
}
#[used]
