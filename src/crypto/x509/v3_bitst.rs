...
static mut ns_cert_type_table: [BIT_STRING_BITNAME; 9] = [
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 0 as libc::c_int,
            lname: b"SSL Client\0" as *const u8 as *const libc::c_char,
            sname: b"client\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            lname: b"SSL Server\0" as *const u8 as *const libc::c_char,
            sname: b"server\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            lname: b"S/MIME\0" as *const u8 as *const libc::c_char,
            sname: b"email\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            lname: b"Object Signing\0" as *const u8 as *const libc::c_char,
            sname: b"objsign\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            sname: b"reserved\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            lname: b"SSL CA\0" as *const u8 as *const libc::c_char,
            sname: b"sslCA\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            lname: b"S/MIME CA\0" as *const u8 as *const libc::c_char,
            sname: b"emailCA\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            lname: b"Object Signing CA\0" as *const u8 as *const libc::c_char,
            sname: b"objCA\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut key_usage_type_table: [BIT_STRING_BITNAME; 10] = [
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 0 as libc::c_int,
            lname: b"Digital Signature\0" as *const u8 as *const libc::c_char,
            sname: b"digitalSignature\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 1 as libc::c_int,
            lname: b"Non Repudiation\0" as *const u8 as *const libc::c_char,
            sname: b"nonRepudiation\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 2 as libc::c_int,
            lname: b"Key Encipherment\0" as *const u8 as *const libc::c_char,
            sname: b"keyEncipherment\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 3 as libc::c_int,
            lname: b"Data Encipherment\0" as *const u8 as *const libc::c_char,
            sname: b"dataEncipherment\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 4 as libc::c_int,
            lname: b"Key Agreement\0" as *const u8 as *const libc::c_char,
            sname: b"keyAgreement\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 5 as libc::c_int,
            lname: b"Certificate Sign\0" as *const u8 as *const libc::c_char,
            sname: b"keyCertSign\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 6 as libc::c_int,
            lname: b"CRL Sign\0" as *const u8 as *const libc::c_char,
    ...
    },
    {
        let mut init = BIT_STRING_BITNAME {
            bitnum: 7 as libc::c_int,
            lname: b"Encipher Only\0" as *const u8 as *const libc::c_char,
            sname: b"encipherOnly\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = BIT_STRING_BITNAME {
            ...
            lname: b"Decipher Only\0" as *const u8 as *const libc::c_char,
            sname: b"decipherOnly\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
unsafe extern "C" fn i2v_ASN1_BIT_STRING(
    mut method: *const X509V3_EXT_METHOD,
    mut ext: *mut libc::c_void,
    mut ret: *mut stack_st_CONF_VALUE,
) -> *mut stack_st_CONF_VALUE {
    let mut bits: *const ASN1_BIT_STRING = ext as *const ASN1_BIT_STRING;
    let mut bnam: *const BIT_STRING_BITNAME = 0 as *const BIT_STRING_BITNAME;
    bnam = (*method).usr_data as *const BIT_STRING_BITNAME;
    while !((*bnam).lname).is_null() {
        if ASN1_BIT_STRING_get_bit(bits, (*bnam).bitnum) != 0 {
            X509V3_add_value((*bnam).lname, 0 as *const libc::c_char, &mut ret);
        }
        bnam = bnam.offset(1);
        bnam;
    }
...
unsafe extern "C" fn v2i_ASN1_BIT_STRING(
    mut method: *const X509V3_EXT_METHOD,
    mut ctx: *const X509V3_CTX,
    mut nval: *const stack_st_CONF_VALUE,
) -> *mut libc::c_void {
    let mut bs: *mut ASN1_BIT_STRING = 0 as *mut ASN1_BIT_STRING;
    ...
    while i < sk_CONF_VALUE_num(nval) {
        ...
        while !((*bnam).lname).is_null() {
            ...
            {
                if ASN1_BIT_STRING_set_bit(bs, (*bnam).bitnum, 1 as libc::c_int) == 0 {
        ...
        if ((*bnam).lname).is_null() {
            ERR_put_error(
                20 as libc::c_int,
                0 as libc::c_int,
                156 as libc::c_int,
                b"/home/ubuntu/workspace/oss/aws-lc/crypto/x509/v3_bitst.c\0"
...
pub static mut v3_nscert: X509V3_EXT_METHOD = unsafe {
    {
        let mut init = v3_ext_method {
            ext_nid: 71 as libc::c_int,
            ext_flags: 0 as libc::c_int,
            it: &ASN1_BIT_STRING_it as *const ASN1_ITEM,
            ext_new: None,
            ext_free: None,
            d2i: None,
            i2d: None,
            ...
            i2r: None,
            r2i: None,
            usr_data: ns_cert_type_table.as_ptr() as *mut libc::c_void,
        };
        init
    }
};
...
pub static mut v3_key_usage: X509V3_EXT_METHOD = unsafe {
    {
        let mut init = v3_ext_method {
            ...
            i2r: None,
            r2i: None,
            usr_data: key_usage_type_table.as_ptr() as *mut libc::c_void,
        };
        init
    }
};
