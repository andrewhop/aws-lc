...
from cdk.aws_lc_custom_hardware_ci_stack import AwsLcCustomHardwareCIStack
...
custom_hardware_build_spec_file = "cdk/codebuild/github_ci_custom_hardware_omnibus.yaml"
AwsLcCustomHardwareCIStack(app, "aws-lc-ci-macos-arm", custom_hardware_build_spec_file, env=env)
